      ...
      <div className={st.wrapper}>
          ...
          <Container head="Навыки">
            <div className={st.skills}>
              {icons.map(([icon, title],i) => {
                return (
                  <div key={icon+i} className={st.skill}>
        ...
        <div className={st.rightSide}>
          <Container head="Сфера деятельности">
            <p>
              Я разработчик и ux/ui дизайнер web-сайтов, использую только современные технологии. 
              На данный момент я ищу подработку по специальности, в зависимости от загруженности могу выполнять разные задачи. 
              Также я люблю работать с новыми технологиями, поэтому изучаю новые и использую их в своей работе. 
              Уделяю большое внимание юзабилити. Ищу работу по совместительству или по договору.
            </p>
          </Container>
          <Container  head="Личность">
              <p>
                Всегда стремлюсь доделать работу, независимо от поставленной задачи подхожу к ней кропотливо и усердно. 
                Стараюсь не допускать ошибок в работе, поэтому тщательно все проверяю. 
                При необходимости всегда ищу необходимую информацию для выполнения задания. 
                Очень редко делаю что то просто ради того чтобы сделать. 
                Люблю когда люди ценят меня как специалиста. 
                Особенно если это касается чего то творческого, где нужно много думать , творить и фантазировать. 
                Я могу часами сидеть и думать над тем как можно сделать что то интересное.
                Могу долго выбирать материалы, искать идеи, придумывать.  
              </p>
          </Container>
        </div>
      </div>
